...
This is a THIN WRAPPER around mwb.lib.reweight_exact's private search
...
Usage: python -m mwb.scripts.solver_efficiency --dataset ende24 [--n-sweep 50]
"""
...
# Secular-equation scan resolution, mirrored from mwb.lib.reweight_exact's
...
def solve_instrumented(
  ...
  """Superset of mwb.lib.reweight_exact.solve_w_exact's search loop with
