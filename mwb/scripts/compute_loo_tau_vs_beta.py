...
dataset D's reachable [beta_min(D), beta_max(D)] (mwb.lib.beta.
beta_min_max), inset by --eps-frac (default 1e-3) of the range at each
end -- mwb.lib.synthetic_scorer_preference.full_range_betas's own
...
Usage: python -m mwb.scripts.compute_loo_tau_vs_beta
