...
family (AF, mwb.lib.synthetic_scorers.base_scorer_family_additive_mean_af,
...
precision rebuild of mwb.lib.synthetic_scorers.AF_ADDITIVE_MEAN_DIAL_GRID
...
Usage: python -m mwb.scripts.plot_spa_plane_synthetic_af_combo
"""
...
from mwb.lib.synthetic_scorers import AF_ADDITIVE_MEAN_DIAL_GRID, all_synthetic_family_points
...
# Sparse (20-point) rebuild of mwb.lib.synthetic_scorers.AFTJ_J_DIAL_GRID's own
