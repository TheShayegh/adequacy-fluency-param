...
n<n_beta>.npz) -- the expensive step (mwb.lib.reweight_exact.solve_w_exact per
beta, a permutation test per scorer, mwb.lib.spa_beta_sweep) separated from
...
SPA(scorer; beta) is mwb.lib.metametrics.weighted_soft_pairwise_accuracy under
...
solving ESS(beta) = --min-ess with Brent's method (mwb.lib.spa_beta_sweep.
...
Usage: python -m mwb.scripts.compute_spa_vs_beta
...
from mwb.lib.spa_beta_sweep import beta_sweep_range, resolve_target_ess, save_spa_vs_beta
