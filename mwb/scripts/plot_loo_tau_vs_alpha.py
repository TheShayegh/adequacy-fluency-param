...
Usage: python -m mwb.scripts.plot_loo_tau_vs_alpha
           --cache output/data/loo_tau_vs_alpha_zhen23_n21.npz
"""
...
from mwb.scripts.plot_scorer_orientation_vs_alpha import (
