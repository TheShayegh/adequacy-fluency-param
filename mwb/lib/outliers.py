...
scores. The modified z-score (Iglewicz & Hoya 1993) uses the median and MAD
(median absolute deviation) instead of mean/std, so it isn't dragged around
by the very outliers it's trying to find, and flags every outlier in a
single pass over the full sample rather than needing iterative removal.
"""
