...
from mwb.lib.beta import beta_0 as _beta_0
...
def synth25_value(
  ...
  mwb.lib.synth25_preference, the one place that bridges the two).
...
def pool_beta_0(
  ...
  """beta_0 (mwb.lib.beta.beta_0: Var(a)/(Var(a)+Var(f)) at uniform
