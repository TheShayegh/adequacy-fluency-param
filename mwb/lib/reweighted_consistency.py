"""Weighted, M(alpha)-style curves through the cross-dataset consistency
...
common target alpha via the EXACT solver (mwb.lib.reweight_exact.
...
w(alpha) lives one level down, and this module is agnostic to it (pass a
