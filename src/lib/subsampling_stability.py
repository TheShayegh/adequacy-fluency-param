...
target_beta via src.lib.reweight_exact.solve_w_exact), and pool the
resulting C(K,p) scorer rankings into a single Kendall's tau-a via
src.lib.consistency.pool_weighted_tau -- the same pooling convention this
...
from src.lib.consistency import pool_weighted_tau, real_scorers, real_systems, scorer_scores
from src.lib.metametrics import NEEDS_SEGMENT_SCORES
...
def leave_p_out_tau(
  ...
  src.lib.consistency.real_scorers(dataset, systems=full_systems,
