...
it was retired after cross-validation against src.lib.reweight_exhaustive
...
from src.lib.beta import beta as beta_of, beta_min_max, pairwise_betas, weighted_mean
