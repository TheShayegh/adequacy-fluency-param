...
src.lib.subsampling_stability's ESS ceiling is an LOO rater's own system count
...
Usage: python -m src.scripts.plot_loo_tau_vs_beta_combo
"""
...
from src.scripts.plot_loo_tau_vs_beta import load_loo_tau_vs_beta
from src.scripts.plot_scorer_preference_vs_beta import SplineReliabilityNorm, _add_ess_colored_line, _ess_over_k_cmap, _ESS_CUTOFF_ABS
