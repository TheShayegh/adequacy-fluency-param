...
PA_synth25 baseline (src.lib.synth25_preference.dataset_synth25_preference)
...
family per base scorer, src.lib.synth25_preference.base_scorer_synth25_preference)
...
preference for the other 5 pools src.lib.synth25_metametrics.POOL_BLOCKS
...
src.lib.synth25_metametrics.pool_beta_0) -- written to a separate
...
Usage: python -m src.scripts.compute_synth25_preference [--dataset ende24]
...
'symmetric') keeps the historical src.lib.synthetic_scorer_preference.
...
synthesis's own T. --dial-preset symmetric instead uses src.lib.
synthetic_scorers.AFTJ_J_DIAL_GRID -- the counterpart of --family-set
AFTJ (whose AF/T side uses the DIFFERENT src.lib.synthetic_scorers.
...
from src.lib.synth25_preference import (
...
from src.lib.synth25_metametrics import POOL_BLOCKS, SYNTH25_METAMETRICS
from src.lib.synthetic_scorer_preference import NEG_J_DIAL_GRID
...
if __name__ == '__main__':
  ...
  parser.add_argument('--synthesis', choices=['offset', 'additive', 'additive_mean'], default='additive_mean',
                       help='which src.lib.synthetic_scorers dial family to build (see '
  ...
  parser.add_argument('--dial-preset', choices=['linear', 'geometric', 'extended', 'symmetric'], default='symmetric',
                       help="'linear': DIAL_GRID, 0/0.1/.../1. 'geometric': GEOM_DIAL_GRID, {2^-i} packed "
                            "toward dial=0. 'extended': src.lib.synthetic_scorers.EXTENDED_ADDITIVE_MEAN_DIAL_GRID "
                            ...
                            "single-dial Adequacy-fluency family, src.lib.synthetic_scorers.AF_ADDITIVE_"
                            "MEAN_DIAL_GRID) instead of separate A/F, plus T on src.lib.synthetic_scorers."
