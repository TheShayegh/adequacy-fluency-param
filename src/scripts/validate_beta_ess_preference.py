"""Cross-validates src.lib.beta_ess_preference_grid.preference_scores -- the
vectorized, quadratic-form SPA path -- against the library's own
src.lib.metametrics.soft_pairwise_accuracy_from_pvalues + src.lib.
...
anchor, in the same spirit as src.lib.reweight_exhaustive standing behind
src.lib.reweight_exact.
...
Usage: python -m src.scripts.validate_beta_ess_preference
...
from src.lib.beta_ess_preference_grid import load_base_scorer_tables, preference_scores
...
from src.lib.synthetic_scorer_preference import preference_score
