...
anywhere at any resolution). See src/lib/beta_ess_preference_grid.py's docstring
for the tradeoff and for the measured agreement between the two.

See src/lib/beta_ess_preference_grid.py's module docstring for the method and,
...
Usage:
  python -m src.scripts.compute_beta_ess_preference_heatmap \
...
from src.lib.beta import beta_0
from src.lib.beta_ess_preference_grid import (
...
#
# Font sizes and pads follow src/scripts/plot_af_scatter_heen23_jazh24.py
...
if __name__ == '__main__':
  ...
  ap.add_argument('--max-per-cell', type=int, default=0,
                  help='cap on points SCORED per cell (0 = no cap, the default). Scoring '
                       ...
                       'src/lib/beta_ess_preference_grid.py), so the cap is rarely needed; it '
