...
(D, lib.synthetic_scorers.donor_family_additive_mean_diagonal): A = dial,
...
precision rebuild of lib.synthetic_scorers.DIAGONAL_ADDITIVE_MEAN_DIAL_GRID
...
This also matches the project's existing convention (lib.spa_plane) of
...
Usage: python codes/scripts/plot_spa_plane_synthetic_diagonal_combo.py
"""
...
from lib.synthetic_scorers import DIAGONAL_ADDITIVE_MEAN_DIAL_GRID, all_synthetic_family_points
...
# Sparse (20-point) rebuild of lib.synthetic_scorers.ABTJ_J_DIAL_GRID's own
