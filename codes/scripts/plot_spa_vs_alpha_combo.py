...
Usage: python codes/scripts/plot_spa_vs_alpha_combo.py
           --caches artifacts/data/spa_vs_alpha_e3a10_n20.npz,artifacts/data/spa_vs_alpha_e3a10_n10.npz
           [--out artifacts/spa_vs_alpha_combo.pdf]
"""
