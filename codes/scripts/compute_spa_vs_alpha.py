...
metrics -- and caches the result to disk (artifacts/data/spa_vs_alpha_<tag>_
n<n_alpha>.npz) -- the expensive step (lib.reweight_exact.solve_w_exact per
alpha, a permutation test per scorer, lib.spa_alpha_sweep) separated from
...
SPA(scorer; alpha) is lib.metametrics.weighted_soft_pairwise_accuracy under
...
solving ESS(alpha) = --min-ess with Brent's method (lib.spa_alpha_sweep.
...
Usage: python codes/scripts/compute_spa_vs_alpha.py
...
from lib.consistency import load_scorer_inputs, real_scorers, real_systems
...
from lib.spa_alpha_sweep import alpha_sweep_range, resolve_target_ess, save_spa_vs_alpha
